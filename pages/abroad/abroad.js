...
Page({
  ...
  onLoad: function (options) {
    ...
    var urlre = require('../../config').viewmerchant + "?openid=" + app.globalData.userInfo.openid + "&cartType=20";
    wx.request({
  ...
  loadCartList: function () {
    wx.request({
      url: require('../../config').cartListUrl + "?openid=" + app.globalData.userInfo.openid + "&cartType=20",
      method: "get",
      header: {
        'content-type': 'application/json' // 默认值
      },
  ...
  btnAddCart: function (e) {
    ...
    wx.request({
      url: require('../../config').cartAddUrl + dataname + "&openid=" + app.globalData.userInfo.openid + "&cartType=20",
      method: "get",
      header: {
        'content-type': 'application/json' // 默认值
      },
  ...
  btnCheckout: function () {
    ...
    wx.navigateTo({
      url: '/pages/sell/checkout/checkout'
    })
  },
